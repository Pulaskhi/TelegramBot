// Se puede sustituir 'Assistant' por 'sequelizeModel' y así es más genérico pero no tan bonito para la lectura
...
exports.findAll = async (req, res, next) => {
  try {
    ...
    const result = await Assistant.findAndCountAll({
      where: condition,
...
exports.findOne = async (req, res, next) => {
  try {
    ...
    const data = await Assistant.findByPk(id)
...
exports.update = async (req, res, next) => {
  try {
    const id = req.params.id
    const [numberRowsAffected] = await Assistant.update(req.body, { where: { id } })
...
exports.delete = async (req, res, next) => {
  try {
    const id = req.params.id
    const numberRowsAffected = await Assistant.destroy({ where: { id } })
